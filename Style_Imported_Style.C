// Mainframe macro generated from application: /usr/local/Cellar/root/6.10.04/bin/root.exe
// By ROOT version 6.10/04 on 2017-09-18 17:21:57
...
void Style_Imported_Style()
{
   ...
   TStyle *tmpStyle = new TStyle("Imported_Style", "Imported from canvas Canvas_1");
